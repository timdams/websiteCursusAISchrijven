...
## Wat zet je daar dan in? {.metonder}

![](assets/regelbestand.png){.figuur}

::: {.onder}
Een tekstbestand van een halve pagina dat je A.I.bij elke nieuwe vraag opnieuw leest. Je
**niet-doen-lijst** weegt daarbij zwaarder dan je wel-doen-lijst: daaraan herkent een lezer
AI-tekst (helemaal wegkrijgen doe je het nooit, *trust me*).
:::
...
## Moet je die zelf schrijven? {.metonder}

![](assets/laatzeschrijven.png){.figuur}

::: {.onder}
Nee. Zij schrijft haar eigen receptenblad, jij leest het na met de rode pen. 😏
:::
...
* Zelf lezen dus: de getallen, de namen, de bronnen, en of het klopt met wat jij
  in de les vertelt. Staat er code in, dan draA.I.je ze.
* Wat je hier corrigeert, gaat naar `improve.md` van stap vijf. Anders kijk je
  het volgende hoofdstuk na op precies hetzelfde.

::: {.kader}
[Eén hulpmiddel wel]{.kop}: laat de A.I. haar eigen tekst nalezen, maar in een
...
**De bevrager** vraagt welke A.I.je hebt en wat je al kan, en geeft je jouw plan.
