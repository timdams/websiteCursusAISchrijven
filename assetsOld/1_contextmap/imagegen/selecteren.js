// Module 1 - dertig documenten zonder reden tegenover vijf met een reden
// Draaien vanuit de imagegen-map:  node selecteren.js
...
const rijen = [
  ['cursustekst',   'een hoofdstuk dat werkt'],
  ['leerdoelen',    'hiermee kan ik nakijken'],
  ['examen',        'welk niveau ik verwacht'],
  ['struikelblok',  'mijn beginsituatie'],
  ['toonvoorbeeld', 'zo moet het klinken'],
];
...
rijen.forEach((rij, i) => {
  const y = ry0 + i * rh;
  c.rect(RX + 140, y, 92, 66, { fill: C.RED_LIGHT, fillStyle: 'hachure', hachureGap: 7,
    fillWeight: 1.4, stroke: C.RED, strokeWidth: 2.2, roughness: 1.5 });
  c.txt(RX + 266, y + 30, rij[0], 34, C.GRAY, 700, 'start');
  c.txt(RX + 266, y + 64, rij[1], 27, C.RED_DARK, 600, 'start');
});
