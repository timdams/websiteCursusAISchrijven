// Module 2, verder-blok - je afspraken worden altijd meegelezen, een skill alleen wanneer nodig
// Draaien vanuit de imagegen-map:  node altijdofsoms.js
const { createCanvas, C } = require('./excal');

const c = createCanvas(1660, 740);

// ---------- de gesprekken in het midden ----------
const taken = [
  [90,  'een oefening vragen'],
  [250, 'een uitleg herschrijven'],
  [410, 'een poster maken'],
...
c.lines(1350, 404, ['alleen wanneer de taak', 'erom vraagt'], 28, C.GRAY, 600, 'middle', 1.3);
c.arrow(1120, 420, 1045, 470, { stroke: C.RED, strokeWidth: 2.4, head: 14 });
c.txt(1350, 566, 'de rest van de tijd', 28, C.GRAY, 600);
c.txt(1350, 600, 'blijft hij liggen', 28, C.GRAY, 600);
